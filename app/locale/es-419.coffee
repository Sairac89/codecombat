...
#    back_to_editing: "Back to Editing"
  ...
  contribute:
    ...
    ambassador_join_desc: "cuéntanos más sobre ti, ¿qué has hecho y qué estarías interesado en hacer? ¡Y continuaremos a partir de ahí!"
  ...
  account:
    ...
    successfully_verified: "¡Has verificado tu email con éxito!"
    verify_error: "Algo salió mal al verificar tu email :("
...
#    purchase_code5: "For more information on Student Licenses, reach out to"
    ...
    copy_link: "Puedes copiar el enlace del código y enviarlo a alguien."
    quantity: "Cantidad"
    redeemed: "Reclamado"
  ...
  loading_error:
    ...
    connection_failure_desc: "¡Al parecer no estás conectado a internet! Revisa tu conexión de red y actualiza la página."
...
#    teacher_notified: "We've notified your teacher that you want to play more CodeCombat in your classroom!"
  ...
  legal:
    ...
    opensource_description_center: "y ayúdanos si quieres! CodeCombat está construido por docenas de proyectos open source, y los amamos. Mira "
    ...
    privacy_description: "No venderemos nada sobre tu información personal."
    ...
    email_description_suffix: "o mediante links en los mails que mandamos, tú puedas cambiar tus preferencias y fácilmente desuscribirte en cualquier momento."
    cost_title: "Costo"
    ...
    rights_desc: "Todos los derechos están reservados para los niveles mismos. Esto incluye."
  ...
  ladder_prizes:
    ...
    blurb_1: "Estos premios serçan dados de acuerdo a "
...
#    line_of_site: "`$1`'s argument `$2` has a problem. Is there an enemy within your line-of-sight yet?"
    ...
    code_never_finished_its: "El código no finalizó. Es demasiado lento o tiene un bucle infinito."
...
#    attacks_argument_enemy_has: "`$1`'s argument `$2` has a problem."
    is_there_an_enemy: "¿Aún hay algún enemigo en tu línea de visión?"
    ...
    put_each_command_on: "Pon cada comando en líneas separadas"
    are_you_missing_a: "¿Te falta un '$1' después de '$2'?"
